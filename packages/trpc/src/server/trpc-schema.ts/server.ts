...
const appRouter = t.router({
  auth: t.router({
    ...
    guestLogin: publicProcedure.input(GuestLoginBodySchema).output(LoginResSchema).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    setup2FA: publicProcedure.output(TwoFactorSetupResSchema).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    disable2FA: publicProcedure.input(DisableTwoFactorAuthBodySchema).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any)
  }),
  admin: t.router({
  ...
  role: t.router({
    ...
    assignPermissions: publicProcedure.input(AssignPermissionsSchema).output(GetRoleDetailResSchema).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any)
  }),
  user: t.router({
  ...
  table: t.router({
    list: publicProcedure.input(GetTablesQuerySchema).output(GetTablesResSchema).query(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    detail: publicProcedure.input(z.object({ id: z.string() })).output(RestaurantTableSchema).query(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    create: publicProcedure.input(CreateTableBodySchema).output(RestaurantTableSchema).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    update: publicProcedure.input(z.object({
      id: z.string(),
      data: UpdateTableBodySchema,
    })).output(RestaurantTableSchema).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    delete: publicProcedure.input(z.object({ id: z.string() })).output(z.any()).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any)
  }),
  order: t.router({
    create: publicProcedure.input(CreateOrderBodySchema).output(OrderSchema).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    list: publicProcedure.input(GetOrdersQuerySchema).output(GetOrdersResSchema).query(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
  ...
  restaurant: t.router({
    list: publicProcedure.input(GetRestaurantsQuerySchema).output(GetRestaurantsResSchema).query(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    detail: publicProcedure.input(z.object({ id: z.string() })).output(RestaurantSchema.extend({ staff: z.any().optional() })).query(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    create: publicProcedure.input(CreateRestaurantBodySchema).output(RestaurantSchema).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    update: publicProcedure.input(z.object({
      id: z.string(),
      data: UpdateRestaurantBodySchema,
    })).output(RestaurantSchema).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    delete: publicProcedure.input(z.object({ id: z.string() })).output(z.any()).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    assignStaff: publicProcedure.input(AssignStaffBodySchema).output(z.any()).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    removeStaff: publicProcedure.input(RemoveStaffBodySchema).output(z.any()).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any)
  }),
  reservation: t.router({
    list: publicProcedure.input(GetReservationsQuerySchema).output(GetReservationsResSchema).query(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    checkAvailability: publicProcedure.input(CheckAvailabilityQuerySchema).output(z.object({ available: z.boolean() })).query(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    create: publicProcedure.input(CreateReservationBodySchema).output(ReservationSchema).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
    update: publicProcedure.input(z.object({
      id: z.string(),
      data: UpdateReservationBodySchema,
    })).output(ReservationSchema).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any)
  })
});
